...
valid_loader = make_dataset_loader('images/valid', 8, False)
...
training_task_map = [
    {
        ...
        "checkpoints": "Classifier/checkpoints/pretrained",
        "logger": ('Classifier/checkpoints/pretrained/log.txt', "Pretrained VGG16 network", '训练次数')
    },
    {
        "n_epochs": 1000,
        "train_loader": train_loader,
        ...
        "logger": ('Classifier/checkpoints/log.txt', "VGG16 network", '训练次数')
    }
]
